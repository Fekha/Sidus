...
public class CameraZoom : MonoBehaviour
{
    ...
    private float moveSpeed = .7f;    // Speed of moving the camera vertically
    private float minZoom = 5.5f;      // Minimum zoom level
    ...
    void Update()
    {
        ...
        if (Input.touchSupported && Input.touchCount == 2)
        {
            ...
            scrollData = (prevTouchDeltaMag - touchDeltaMag) * zoomSpeed * 0.01f; // Scale down for smoother pinch zoom
        }
